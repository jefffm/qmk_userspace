...
// |--------+---------+---------+---------+--------+--------+-------------------------------------------------+--------+---------+---------+---------+--------+---------|
    _______ , _______ , _______ , _______ , _______, _______,                                                  _______ , _______ , _______ , _______ , _______, _______ ,
// |--------+---------+---------+---------+--------+--------|                                                 |--------+---------+---------+---------+--------+---------|
    _______ , XXXXXXX , SWAP    , XXXXXXX , SSHOT  ,XXXXXXX ,                                                  KC_TAB  , KC_HOME , KC_UP   , KC_END  , KC_DEL , _______ ,
// |--------+---------+---------+---------+--------+--------|                                                 |--------+---------+---------+---------+--------+---------|
    _______ , OS_LCTL , OS_LALT , OS_LGUI , OS_LSFT, KC_BSPC,                                                  KC_DEL  , KC_LEFT , KC_DOWN , KC_RIGHT, KC_BSPC, _______ ,
// |--------+---------+---------+---------+--------+--------|                                                 |--------+---------+---------+---------+--------+---------|
